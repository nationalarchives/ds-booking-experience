...
* We are not seeking to limit the number of users who can come in for PC access only.
...
* We would not seek to mandate a multi-date visit based on the number of documents ordered.
